var amt = parseInt(document.getElementById('InitAmount'));
var percent = parseInt(document.getElementById('Percent'));
...
document.getElementById("Submit").addEventListener("submit", calc_goal(amt, percent), false);
